const translations = {
  "zh-CN": {
    ...
    heroBody: "贴着 Dock 查看 Token 用量、周额度与任务状态。只读本机数据，不打断当前工作。",
    ...
    panelLast14: "近 14 天", panelDateStart: "7月10日", panelDateEnd: "7月23日　1.42M",
    ...
    panelSession: "# 打磨公开发布体验", panelTask1: "像素级复刻两个 Dock 面板",
    panelTask2: "创建 GitHub 公开仓库并启用 Pages", panelTask3: "运行完整测试",
    mockupNote: "HTML/CSS 界面复刻 · 演示数据",
    featuresTitle: "专注写代码，<br>其余交给桌面。",
    featuresBody: "两个透明、非激活面板安静地贴在 Dock 两侧。需要时扫一眼，不需要时它们留在应用窗口之后。",
    featureUsageTitle: "用量一眼看清", featureUsageBody: "14 天 Token 趋势、今日消耗、周额度与重置倒计时，安静地待在 Dock 一侧。",
    trendLast14: "最近 14 天", trendToday: "今日 1.42M",
    featureTasksTitle: "任务状态，贴着 Dock 发生", featureTasksBody: "按项目与会话查看执行中和最近完成的任务，会话标题可以直接回到 Codex。",
    miniSession: "发布落地页", miniTask1: "验证桌面与移动端视觉", miniTask2: "运行完整测试",
    featurePlacementTitle: "跟着你的桌面走", featurePlacementBody: "支持 Dock 位于底部、左侧或右侧，面板位置、宽度与文字对齐均可调整并保存。",
    privacyTitle: "你的数据，<br>不离开这台 Mac。",
    privacyBody: "Codex Pulse 只读扫描本机 Codex 会话日志与任务索引，不上传用量数据，也不会修改原始记录。",
    privacy1: "仅启用 Codex 数据源", privacy2: "无需屏幕录制权限", privacy3: "休眠或锁屏时暂停刷新",
  ...
  "zh-HK": {
    ...
    heroBody: "貼近 Dock 查看 Token 用量、每週限額與任務狀態。唯讀本機資料，不打斷當前工作。",
    ...
    panelLast14: "近 14 日", panelDateStart: "7月10日", panelDateEnd: "7月23日　1.42M",
    ...
    panelSession: "# 完善公開發佈體驗", panelTask1: "像素級重現兩個 Dock 面板",
    panelTask2: "建立 GitHub 公開儲存庫並啟用 Pages", panelTask3: "執行完整測試",
    mockupNote: "HTML/CSS 介面重現 · 示範資料",
    featuresTitle: "專注寫程式，<br>其餘交給桌面。",
    featuresBody: "兩個透明、非啟用面板安靜地貼在 Dock 兩側。需要時看一眼，不需要時留在應用程式視窗之後。",
    featureUsageTitle: "用量一目了然", featureUsageBody: "14 日 Token 趨勢、今日消耗、每週限額與重設倒數，安靜地留在 Dock 一側。",
    trendLast14: "最近 14 日", trendToday: "今日 1.42M",
    featureTasksTitle: "任務狀態，貼近 Dock 發生", featureTasksBody: "按專案與工作階段查看進行中及最近完成的任務，點擊標題即可返回 Codex。",
    miniSession: "發佈落地頁", miniTask1: "驗證桌面與流動版畫面", miniTask2: "執行完整測試",
    featurePlacementTitle: "跟隨你的桌面", featurePlacementBody: "支援 Dock 位於底部、左側或右側；面板位置、寬度和文字對齊均可調整並儲存。",
    privacyTitle: "你的資料，<br>不會離開這部 Mac。",
    privacyBody: "Codex Pulse 只會以唯讀方式掃描本機 Codex 工作階段記錄與任務索引，不會上載用量資料或修改原始記錄。",
    privacy1: "只啟用 Codex 資料來源", privacy2: "毋須螢幕錄影權限", privacy3: "睡眠或鎖定時暫停更新",
  ...
  "zh-TW": {
    ...
    heroTitle: "讓 Codex 的每一次脈動，<br>都留在桌面上。",
    heroBody: "貼著 Dock 查看 Token 用量、每週限額與任務狀態。唯讀本機資料，不打斷目前工作。",
    viewGithub: "在 GitHub 查看", quickStart: "快速開始", previewLabel: "Codex Pulse 介面示意",
    menuFile: "檔案", menuEdit: "編輯", menuWindow: "視窗",
    usagePanelLabel: "用量概覽面板示意", taskPanelLabel: "任務活動面板示意",
    panelLast14: "近 14 天", panelDateStart: "7月10日", panelDateEnd: "7月23日　1.42M",
    ...
    panelSession: "# 打磨公開發布體驗", panelTask1: "像素級重現兩個 Dock 面板",
    panelTask2: "建立 GitHub 公開儲存庫並啟用 Pages", panelTask3: "執行完整測試",
    mockupNote: "HTML/CSS 介面重現 · 示範資料",
    featuresTitle: "專注寫程式，<br>其餘交給桌面。",
    featuresBody: "兩個透明、非啟用面板安靜地貼在 Dock 兩側。需要時看一眼，不需要時留在應用程式視窗之後。",
    featureUsageTitle: "用量一目瞭然", featureUsageBody: "14 天 Token 趨勢、今日消耗、每週限額與重設倒數，安靜地待在 Dock 一側。",
    trendLast14: "最近 14 天", trendToday: "今日 1.42M",
    featureTasksTitle: "任務狀態，貼著 Dock 發生", featureTasksBody: "依專案與工作階段查看執行中及最近完成的任務，點擊標題即可回到 Codex。",
    miniSession: "發布落地頁", miniTask1: "驗證桌面與行動版畫面", miniTask2: "執行完整測試",
    featurePlacementTitle: "跟著你的桌面走", featurePlacementBody: "支援 Dock 位於底部、左側或右側；面板位置、寬度與文字對齊都能調整並儲存。",
    privacyTitle: "你的資料，<br>不會離開這台 Mac。",
    privacyBody: "Codex Pulse 只會以唯讀方式掃描本機 Codex 工作階段記錄與任務索引，不會上傳用量資料或修改原始記錄。",
    privacy1: "僅啟用 Codex 資料來源", privacy2: "不需螢幕錄影權限", privacy3: "睡眠或鎖定時暫停更新",
  ...
  ja: {
    ...
    heroBody: "Dock の横で Token 使用量、週間上限、タスク状態を確認。ローカルデータを読み取るだけで、作業を妨げません。",
    ...
    panelLast14: "過去14日", panelDateStart: "7月10日", panelDateEnd: "7月23日　1.42M",
    ...
    panelSession: "# 公開リリースを仕上げる", panelTask1: "2つの Dock パネルを忠実に再現",
    panelTask2: "GitHub 公開リポジトリと Pages を作成", panelTask3: "全テストを実行",
    ...
    featureUsageTitle: "使用量をひと目で", featureUsageBody: "14日間の Token 推移、今日の使用量、週間上限、リセットまでの時間を Dock の横に表示します。",
    trendLast14: "過去14日", trendToday: "今日 1.42M",
    featureTasksTitle: "タスクの動きを Dock のそばに", featureTasksBody: "プロジェクトとセッション別に実行中・完了タスクを確認し、タイトルから Codex に戻れます。",
    miniSession: "ランディングページを公開", miniTask1: "デスクトップとモバイル表示を確認", miniTask2: "全テストを実行",
    ...
    privacyBody: "Codex Pulse はローカルの Codex セッションログとタスクインデックスを読み取り専用で確認し、使用量の送信や元データの変更はしません。",
    privacy1: "Codex データソースのみ有効", privacy2: "画面収録の権限は不要", privacy3: "スリープ・ロック中は更新を停止",
  ...
  ko: {
    ...
    heroBody: "Dock 옆에서 Token 사용량, 주간 한도와 작업 상태를 확인하세요. 로컬 데이터를 읽기만 하며 작업을 방해하지 않습니다.",
    ...
    panelLast14: "최근 14일", panelDateStart: "7월 10일", panelDateEnd: "7월 23일　1.42M",
    ...
    panelSession: "# 공개 배포 경험 다듬기", panelTask1: "두 Dock 패널을 픽셀 단위로 재현",
    panelTask2: "GitHub 공개 저장소 및 Pages 만들기", panelTask3: "전체 테스트 실행",
    ...
    featureUsageTitle: "사용량을 한눈에", featureUsageBody: "14일 Token 추이, 오늘 사용량, 주간 한도와 초기화 카운트다운을 Dock 한쪽에서 확인합니다.",
    trendLast14: "최근 14일", trendToday: "오늘 1.42M",
    featureTasksTitle: "Dock 옆에서 흐르는 작업 상태", featureTasksBody: "프로젝트와 세션별로 진행 중이거나 최근 완료된 작업을 보고 제목을 눌러 Codex로 돌아갑니다.",
    miniSession: "랜딩 페이지 배포", miniTask1: "데스크톱 및 모바일 화면 검증", miniTask2: "전체 테스트 실행",
    ...
    privacyBody: "Codex Pulse는 로컬 Codex 세션 로그와 작업 인덱스를 읽기 전용으로 확인하며 사용량을 업로드하거나 원본 기록을 수정하지 않습니다.",
    privacy1: "Codex 데이터 소스만 활성화", privacy2: "화면 기록 권한 불필요", privacy3: "잠자기·잠금 중 새로 고침 중지",
  ...
  en: {
    ...
    heroBody: "See token usage, weekly limits, and task activity beside the Dock. It reads local data only and stays out of your way.",
    ...
    panelLast14: "Last 14 days", panelDateStart: "Jul 10", panelDateEnd: "Jul 23　1.42M",
    ...
    panelSession: "# Polish the public release", panelTask1: "Recreate both Dock panels pixel-perfectly",
    panelTask2: "Create the public repo and enable Pages", panelTask3: "Run the full test suite",
    ...
    featureUsageTitle: "Usage at a glance", featureUsageBody: "A 14-day token trend, today's usage, weekly limit, and reset countdown stay quietly beside the Dock.",
    trendLast14: "Last 14 days", trendToday: "Today 1.42M",
    featureTasksTitle: "Task activity, right beside the Dock", featureTasksBody: "See running and recently completed tasks by project and session, then jump back to Codex from a session title.",
    miniSession: "Publish landing page", miniTask1: "Verify desktop and mobile visuals", miniTask2: "Run the full test suite",
    ...
    privacyBody: "Codex Pulse reads local Codex session logs and task indexes without uploading usage data or modifying the source records.",
    privacy1: "Only the Codex source is enabled", privacy2: "No Screen Recording permission", privacy3: "Refresh pauses while asleep or locked",
